...
| `dfSiteMeta` | Tibble containing site-level descriptive fields such as `Status` and `InvestigatorLastName`. | Textual site metadata and site labeling support. |
